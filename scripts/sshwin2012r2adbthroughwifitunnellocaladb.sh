...
echo Open localhost:2222 on android for adb forwarding
/home/mark/Downloads/platform-tools/adb forward tcp:2222 tcp:2222
...
autossh -M 9995 -o "ServerAliveInterval 30" -o "ServerAliveCountMax 5" -R 127.0..0.1:8600:127.0.0.1:8600 -R 127.0.0.1:8700:127.0.0.1:8600 -R 127.0.0.1:15432:127.0.0.1:15432 -w 3:3 -C -R 127.0.0.1:5037:127.0.0.1:5037 -L 127.0.0.1:5900:127.0.0.1:5900 -L 127.0.0.1:5800:127.0.0.1:5800 -L 127.0.0.1:3389:127.0.0.1:3389 -D 127.0.0.1:8888 mark@127.0.0.1 -p 2222 -N
