...
# WATCHOUT BLOCKING DNS!
   iptables -A INPUT -d 127.0.0.1 -p udp --dport 53 -j DROP
   iptables -A INPUT -d 127.0.0.1 -p tcp --dport 53 -j DROP
   iptables -A INPUT -d 127.0.0.1 -p udp --dport 5353 -j DROP
   iptables -A INPUT -d 127.0.0.1 -p tcp --dport 5353 -j DROP
...
iptables -A INPUT -s 40.121.213.9 -p tcp --sport 22 -j ACCEPT
 ...
 # iptables -A INPUT -p udp --sport 5353 -j ACCEPT
   ...
   iptables -A INPUT -s 10.42.0.198 -p tcp --sport 8022 -j ACCEPT
   ...
   iptables -A INPUT -d 192.168.44.1 -s 192.168.44.66 -p tcp --dport 443 -j ACCEPT
...
#iptables -A INPUT -s 127.0.0.1 -p tcp --sport 9222 -j ACCEPT
#iptables -A INPUT -s 127.0.0.1 -p tcp --dport 9222 -j ACCEPT
#iptables -A INPUT -s 127.0.0.1 -p tcp --sport 9229 -j ACCEPT
#iptables -A INPUT -s 127.0.0.1 -p tcp --dport 9229 -j ACCEPT
...
#iptables -A OUTPUT -p tcp --sport 9222 -j ACCEPT
#iptables -A OUTPUT -p tcp --dport 9229 -j ACCEPT
#iptables -A OUTPUT -p tcp --sport 9229 -j ACCEPT
...
iptables -A OUTPUT -s 192.168.44.1 -d 192.168.44.66 -p tcp --sport 443 -j ACCEPT
...
iptables -A OUTPUT -p tcp --sport 53 -j DROP
   ...
   iptables -A OUTPUT -p tcp --sport 5353 -j DROP
...
iptables -A OUTPUT -d 40.121.213.9 -p tcp --dport 22 -j ACCEPT
   ...
   iptables -A OUTPUT -d 10.42.0.198 -p tcp --dport 8022 -j ACCEPT
